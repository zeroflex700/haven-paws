...
return (
  <div className="flex h-full flex-col bg-[#faf9f5]">
    ...
    <div className="shrink-0 border-b border-sage/10 bg-white">
    ...
    <div className="shrink-0 border-t border-sage/10 bg-white px-4 py-4 pb-[calc(1rem+env(safe-area-inset-bottom))] sm:px-6">
