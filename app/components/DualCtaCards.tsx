  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-14 grid md:grid-cols-2 gap-5">
      <div className="bg-cream-alt rounded-lg p-6">
        ...
        <Link href="/contact#breeder-application" className="inline-flex items-center gap-1 text-sm text-forest">
      ...
      <div className="bg-cream-alt rounded-lg p-6">
        ...
        <Link href="/contact" className="inline-flex items-center gap-1 text-sm text-forest">
          Learn more <ArrowRight size={14} />
        </Link>
      </div>
    </section>
