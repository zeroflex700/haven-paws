...
const notificationItems = [
  {
    ...
    label: "News & Tips",
    description: "Occasional stories, puppy-care advice, and useful Haven Paws updates.",
    icon: Mail,
  },
  {
  ...
  },
  {
    ...
    description: "Hear about puppies that match your breed and search preferences.",
    icon: PawPrint,
  },
  {
    key: "surveysFeedback" as const,
    label: "Surveys & Feedback",
    description: "Occasional opportunities to help us improve Haven Paws.",
    icon: MessageSquare,
  },
  {
    key: "ownerGuide" as const,
    label: "Puppy Owner Guide",
    description: "Helpful guidance and resources after your puppy arrives home.",
    icon: PawPrint,
  },
];
...
export default function SettingsClient() {
  ...
  async function handleAvatarUpload(
    ...
    try {
      ...
      showToast("success", "Your profile photo has been updated.");
    } catch {
      showToast(
        "error",
  ...
  async function saveProfile() {
    ...
    try {
      ...
      showToast("success", "Your account details have been saved.");
    } catch {
      showToast(
        "error",
  ...
  function addBreed(breed: string) {
    ...
    setPrefs({
      ...prefs,
      breedUpdates: [...prefs.breedUpdates, breed],
    });
  ...
  const filteredBreedSuggestions = useMemo(() => {
    ...
    const query = breedInput.trim().toLowerCase();
        ...
        <div className="grid lg:grid-cols-[250px_minmax(0,1fr)] gap-8 xl:gap-10">
          ...
          <aside className="lg:sticky lg:top-24 lg:self-start">
            <div className="rounded-2xl border border-sage/15 bg-white overflow-hidden">
                ...
                <div className="flex items-center gap-3">
                  <div className="relative h-12 w-12 shrink-0 rounded-full overflow-hidden bg-cream-alt">
                    {profile.avatarUrl ? (
                      ...
                      <img
                        src={cldThumb(profile.avatarUrl, 120)}
                        alt=""
              ...
              {/* Navigation */}
              <nav className="p-2" aria-label="Account settings">
                {TABS.map((item) => {
          ...
          <div className="min-w-0">
            ...
            {activeTab === "notifications" && (
              <NotificationsSection
                ...
                filteredBreedSuggestions={filteredBreedSuggestions}
                addBreed={addBreed}
            ...
            <div className="relative shrink-0">
              <div className="h-24 w-24 rounded-full overflow-hidden bg-cream-alt border-4 border-cream">
                {profile.avatarUrl ? (
                  // eslint-disable-next-line @next/next/no-img-element
                  <img
                    src={cldThumb(profile.avatarUrl, 200)}
                    alt=""
                    className="h-full w-full object-cover"
                  />
                ) : (
...
function NotificationsSection({
  ...
  >;
  breedInput: string;
  setBreedInput: React.Dispatch<React.SetStateAction<string>>;
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-sage mt-0.5">
                Helpful updates sent to {prefs ? "your email" : "you"}.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-5 sm:p-7">
          ...
          <div className="mt-7">
            ...
            >
              ...
              <option value="male">Male puppies</option>
              <option value="female">Female puppies</option>
            </select>
          </div>
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-sage/15 bg-white p-5 sm:p-7">
        ...
        <p className="text-sm text-ink/65 leading-6 mt-2">
          ...
          transparent, and secure. Review our terms before making any
          purchase.
        </p>
