...
export default function AdminNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-forest border-t border-forest-light flex justify-around py-2 z-50 overflow-x-auto">
      {tabs.map(({ href, label, icon: Icon }) => {
        ...
        return (
          <Link
            key={href}
            href={href}
            className={`flex flex-col items-center gap-1 px-3 py-1 text-xs shrink-0 ${
