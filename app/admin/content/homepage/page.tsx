  ...
  return (
    <main className="px-5 pt-6 pb-10">
      ...
      <p className="text-sm text-sage mb-6">
        ...
        <Link href="/admin/video-stories" className="underline text-forest">/admin/video-stories</Link>,
        location cards at{" "}
        <Link href="/admin/location-cards" className="underline text-forest">/admin/location-cards</Link>,
        &quot;Keep Exploring&quot; cards at{" "}
        <Link href="/admin/exploring-cards" className="underline text-forest">/admin/exploring-cards</Link>.
      </p>
